-- 021_fix_vista_costes_docena.sql
-- La vista vista_coste_platos no considera que los ingredientes medidos en
-- docenas tienen la cantidad en unidades (no docenas). Se añade factor 1/12
-- cuando unidad_medida = 'docena'.
